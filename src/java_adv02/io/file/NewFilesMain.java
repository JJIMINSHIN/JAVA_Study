...
public class NewFilesMain {
	...
	public static void main(String args[]) throws IOException {
		Path file = Path.of("temp/exampleNew.txt");
		Path dic = Path.of("temp/exampleNewDir");
		...
		System.out.println("Is directory: " + Files.isDirectory(dic));
		...
		Path newFile = Paths.get("temp/newExample2.txt");
